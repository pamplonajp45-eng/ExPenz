      ...
      >
        ...
        <View style={styles.summaryContainer}>
          <View style={styles.summaryBox}>
            <Text
              style={[styles.summaryLabel, { color: theme.muted }]}
              numberOfLines={1}
            ...
            <Text
              style={[styles.summaryValue, { color: theme.green }]}
              numberOfLines={1}
              adjustsFontSizeToFit
            >
          ...
          <View style={styles.summaryBox}>
            ...
            <Text
              style={[styles.summaryValue, { color: theme.red }]}
              numberOfLines={1}
              adjustsFontSizeToFit
            >
                  ...
                  >
                    <Text
                      style={[
                        ...
                        {
                          color:
                            utang.type === "lent" ? theme.green : theme.red,
                        },
                      ]}
                    >
          ...
          >
            ...
            <View style={styles.typeSelector}>
              <TouchableOpacity
                style={[
                  styles.typeBtn,
                  newType === "lent" && { backgroundColor: theme.green },
                ]}
              ...
              >
                <Text
                  style={[
                    styles.typeBtnTxt,
                    { color: newType === "lent" ? "#fff" : theme.muted },
                  ]}
                >
                  Nagpautang Ako (Receivable)
                </Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[
                  styles.typeBtn,
                  newType === "borrowed" && { backgroundColor: theme.red },
                ]}
              ...
              >
                <Text
                  style={[
                    styles.typeBtnTxt,
                    { color: newType === "borrowed" ? "#fff" : theme.muted },
                  ]}
                >
                  Umutang Ako (Payable)
                </Text>
            ...
            >
              {actionLoading ? (
                ...
                <Text style={styles.saveBtnText}>Idagdag</Text>
              )}
            </TouchableOpacity>
          </View>
        </KeyboardAvoidingView>
          ...
          >
              ...
              <View style={{ marginBottom: 16 }}>
                <Text style={{ color: theme.muted }}>
                  ...
                  <Text style={{ color: theme.text, fontWeight: "700" }}>
                    {selectedUtang.person_name}
                  </Text>
                </Text>
                <Text style={{ color: theme.muted }}>
                  Current Balance:{" "}
                  <Text style={{ color: theme.red, fontWeight: "700" }}>
                    ₱{selectedUtang.balance.toLocaleString()}
                  </Text>
                </Text>
              </View>
            )}
            ...
            >
              {actionLoading ? (
                ...
                <Text style={styles.saveBtnText}>I-log ang Bayad</Text>
              )}
            </TouchableOpacity>
          </View>
        </KeyboardAvoidingView>
